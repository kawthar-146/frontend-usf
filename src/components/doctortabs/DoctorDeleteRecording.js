...
export default function DoctorDeleteRecording(props) {
    
    async function onSubmit(e) {
        e.nativeEvent.preventDefault();
        props.deleteFile();
        props.setDeleteRecordingTab(false);
    }
        ...
        <div className="popup_delete">
            <div className="popup_delete_content">
                ...
                <div className="pop_delete_buttons">
                    <span className="cancel_button" onClick={() => props.setDeleteRecordingTab(false)}>
                        {" "}
                        Cancel
                    </span>
                    <button
